                                            ...
                                            <div class="card-body"><h5 class="card-title">Describe Your Event</h5>
                                                <div>
                                                    <div class="input-group">
                                                        ...
                                                        <input placeholder="Type of event you are having" type="text" class="form-control"></div>
                                                    <br>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend"><span class="input-group-text">Your Budget Amount</span></div>
                                                        <input placeholder="Amount you plan to spend"  type="number" class="form-control">
                                                        <div class="input-group-append"><span class="input-group-text">.00</span></div>
                                                    </div>
                                                    <br>
                                                    <div class="position-relative form-group"><label for="exampleCustomSelect" class="">Do you have a Prefered location?</label><select type="select" id="exampleCustomSelect" name="customSelect" class="custom-select">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input placeholder="Name of the area you want your event at" type="text" class="form-control"></div>
                                                    <br>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend"><span class="input-group-text">Preferred Venue</span></div>
                                                        <input placeholder="Name of your preferred Event Center" type="text" class="form-control"></div>
                                                    <br>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend"><span class="input-group-text">Number of Expected Attendants</span></div>
                                                        <input placeholder="No of people you expect" type="number" class="form-control"></div>
                                                    <br>
                                            ...
                                            <div class="main-card mb-3 card">
                                                <div class="card-body"><h5 class="card-title">Specify Things You want added to your Budget</h5>
                                                    <div class="position-relative form-group">
                                                        <div>
                                                            <div class="custom-checkbox custom-control"><input type="checkbox" id="exampleCustomCheckbox" class="custom-control-input"><label class="custom-control-label" for="exampleCustomCheckbox">Feeding</label></div>
                                                            <div class="custom-checkbox custom-control"><input type="checkbox" id="exampleCustomCheckbox2" class="custom-control-input"><label class="custom-control-label" for="exampleCustomCheckbox2">Accomodation</label></div>
                                                            <div class="custom-checkbox custom-control"><input type="checkbox" id="exampleCustomCheckbox2" class="custom-control-input"><label class="custom-control-label" for="exampleCustomCheckbox2">Transportation</label></div>
                                                        </div>
                                                    </div>
                                                            <div class="position-relative form-group"><label for="exampleCustomSelect" class="">Do you have a Prefered location?</label><select type="select" id="exampleCustomSelect" name="customSelect" class="custom-select">
                                                                <option value="">Select</option>
                                    ...
                                    <div class="card-body"><h5 class="card-title">Your Details</h5>
                                        <form class="">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="position-relative form-group"><label for="exampleZip" class="">Zip Code</label><input name="zip" id="exampleZip" type="text" class="form-control"></div>
                                                </div>
                                            </div>
                                            <div class="position-relative form-check"><input name="check" id="exampleCheck" type="checkbox" class="form-check-input"><label for="exampleCheck" class="form-check-label">Agree to EventGuru Terms and Conditions</label></div>
