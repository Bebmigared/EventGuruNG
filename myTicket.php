...
<head>
	...
	<title> Event Map - My Event Tickets</title>
                    ...
                    <div class="app-main__inner">
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content bg-midnight-bloom">
                                    ...
                                    <?php include 'mytik.php'; ?>
                                        <div class="widget-content-left">
                                            <div class="widget-heading">Total Events</div>
                                            <div class="widget-subheading">All events I Registered</div>
                                        </div>
                                        <div class="widget-content-right">
                                            <div class="widget-numbers text-white"><span><?php echo count($mytik); ?></span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-header" >List of Events
                                    ...
                                    <div class="table-responsive">
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-center">Print Ticket</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            <?php 
                                            for ($row = 0; $row < count($mytik); $row++) {
                                              //  print_r ($myeve);
                                            //return false;
                                            $number = $row +1;
                                                ?>
                                            ...
                                            <tr>
                                                    ...
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                                                            <div class="widget-content-left mr-3">
                                                                <div class="widget-content-left">
                                                                    <img width="50" src="<?= !isset($mytik[$row]['flyer']) ? "../uploads/defaultimg.png": $mytik[$row]['flyer'] ?>" alt="flyer">
                                                                    <!--<img width="50" src="signing/new/<= $myeve[$row]['flyer'] ?>" alt="flyer">-->
                                                                    <!--<= !isset($_SESSION['user']['picture']) ?  "user.png": $_SESSION['user']['picture'] ?>-->
                                                                </div>
                                                            </div>
                                                            <div class="widget-content-left flex2">
                                                                <div class="widget-heading"><?= $mytik[$row]['eventname'] ?></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <? echo $msg;?>
                                                <td class="text-center"><?php echo $mytik[$row]['venue'] ?> &nbsp;<?php echo $mytik[$row]['location'] ?> </td>
                                                ...
                                                <td class="text-center">
                                                <a href="e_details.php/?d=<?=$mytik[$row]['id']?>"  id="myBtn<?=$row?>">Details</a><!-- Trigger/Open The Modal -->
                                                </td>
