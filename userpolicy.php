...
<div class="page-heading">
	<h1 class="entry-title">About Unievent</h1>
                                ...
                                <div class="spacial-features">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="header">
                                                    <h2 id="animate-on-focus" data-animate="zoomInDown" data-animate-delay="0.4" data-animate-duration="3">COLLECTION OF INFORMATION</h2>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="spacial-features">
                                            <section class="container">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="header">
                                                            <h2 id="animate-on-focus" data-animate="zoomInDown" data-animate-delay="0.4" data-animate-duration="3">USE OF INFORMATION COLLECTED</h2>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                        ...
                                        <div class="spacial-features">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="header">
                                                            <h2 id="animate-on-focus" data-animate="zoomInDown" data-animate-delay="0.4" data-animate-duration="3">SHARING OF PERSONAL DATA AND DISCLOSURE</h2>
                                        ...
                                        <div class="spacial-features">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="header">
                                                            <h2 id="animate-on-focus" data-animate="zoomInDown" data-animate-delay="0.4" data-animate-duration="3">CHOICE, ACCESS AND CHANGE</h2>
                                                        </div>
                                                    </div>
                                                </div>
                                                <section class="container">
                                        ...
                                        <div class="spacial-features">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="header">
                                                            <h2 id="animate-on-focus" data-animate="zoomInDown" data-animate-delay="0.4" data-animate-duration="3">INFORMATION RETENTION OR DELETION</h2>
                                                        </div>
                                                    </div>
                                                </div>
                                                <section class="container">
...
<!-- Footer  Ends -->
	...
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAn1UqYmfSUL3fLZhnjWHNcVN2B0VUPXM8&amp;callback=initMap"
    async defer></script>
</body>
</html>