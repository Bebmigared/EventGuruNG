...
<head>
	...
	<title> Event Map - Create an Event</title>
...
<div class="page-heading">
	<h1 class="entry-title entry-title-event3">Create Event</h1>

</div>
<div class="container">
	
		<div class="wrap-contact100">
			<form id="regForm" action="create.php" method="POST" class="contact100-form validate-form">
				<fieldset>
					<br>
				...
				<div class="form-group row">
					<div class="col-xs-4">
							...
							<input class="form-date" id="startdate" type="date" data-date-format="DD MMMM YYYY"min="2019-01-01" name="startdate">
								<script>
					...
					<div class="col-xs-4">
							...
							<input class="form-date" type="time"  name="starttime">
					</div>
				...
				<div class="form-group row">
					<div class="col-xs-4">
							...
							<input class="form-date" id="enddate" type="date" data-date-format="DD MMMM YYYY" max="2028-12-31" name="enddate" required>
								<script>
