...
try {
    ...
    $mail->Host = 'eventguru.ng';  // Specify main and backup SMTP servers

    $mail->SMTPAuth = true;                                   // Enable SMTP authentication

    $mail->Username = 'contact@eventguru.ng';                     // SMTP username

    $mail->Password = '4{JjxE4cyC_v';                               // SMTP password
    ...
    $mail->setFrom('info@eventguru.ng', 'EventGuru');
