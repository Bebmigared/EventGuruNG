...
<div class="page-heading">
	<h1 class="entry-title entry-title-event3">Lagos Business Conference</h1>
...
<br><br><br><br><br>
				...
				<div class="col-md-3">
					...
					<div class="event-details-event3">
						<h3>event details</h3>
						<ul>
							<li><span><i class="fa fa-calendar-check-o" aria-hidden="true"></i> Start Date:</span> 8:00, Oct 12, 2017</li>
							<li><span><i class="fa fa-calendar-times-o" aria-hidden="true"></i> Finish Date:</span> 17:00, Oct 14, 2017</li>
							<li><span><i class="fa fa-map-marker" aria-hidden="true"></i> Location:</span> Ikeja, Lagos</li>
							<li><span><i class="fa fa-university" aria-hidden="true"></i> Venue:</span> Ikeja City Hotel</li>
							<li><span><i class="fa fa-key" aria-hidden="true"></i> Organizer:</span>EKO Summit</li>
							<li><span><i class="fa fa-folder-open" aria-hidden="true"></i> Category:</span> Business</li>
							<li><span><i class="fa fa-street-view" aria-hidden="true"></i> Seats:</span> 500 Seats</li>
					...
					<div class="entry-register-now-event3">
						<div class="frm-register">
	    					...
	    					<form class="frm-res" action="eregister.php" method="post">
	    						...
	    						<input name="fullname" type="text" placeholder="Your Full Name" class="fullname"><span class = "erro">* </span>
	    						<input name="email" type="email" placeholder="Your Email" class="email"><span class = "erro">* </span>
