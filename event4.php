...
<div class="page-heading">
	<h1 class="entry-title entry-title-event3">IKEJA MUSIC FESTIVAL</h1>
...
<br><br><br><br><br>
				...
				<div class="col-md-3">
					...
					<div class="event-details-event3">
						<h3>Event details</h3>
						<ul>
							<li><span><i class="fa fa-calendar-check-o" aria-hidden="true"></i> Start Date:</span> 8:00, July 29, 2019</li>
							<li><span><i class="fa fa-calendar-times-o" aria-hidden="true"></i> Finish Date:</span> 17:00, July 29, 2019</li>
							<li><span><i class="fa fa-map-marker" aria-hidden="true"></i> Location:</span> Opebi, Ikeja, Lagos</li>
							<li><span><i class="fa fa-university" aria-hidden="true"></i> Venue:</span> Ikeja City Hall</li>
							<li><span><i class="fa fa-key" aria-hidden="true"></i> Organizer:</span>Music Hub</li>
							<li><span><i class="fa fa-folder-open" aria-hidden="true"></i> Category:</span> Music</li>
