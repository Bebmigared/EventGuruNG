	...
	<div class="entry-content">
		...
		<div class="entry-single-event3">
			<div class="container">
				<div class="col-md-9">
					<div class="banner">
						<!--<img src="images/single-event3.jpg" alt="single event" align="middle">-->
						<img src="signing/new/<?= !isset($_SESSION['this_event']['flyer']) ?  "../../images/defaultimg.png": $_SESSION['this_event']['flyer'] ?>" alt="single event" align="middle">
...
<br><br><br><br><br>
					...
					<div class="entry-tabs" role="tabpanel">
						<ul class="list-tabs" role="tablist">
							<li  role="presentation" class="active" style="padding: 0px !important;"><a class="active" role="tab" data-toggle="tab" href="#tab-event1"><i class="fa fa-file-text-o" aria-hidden="true"></i> Content</a></li>
							<li  role="presentation" style="padding: 0px !important;"><a  role="tab" data-toggle="tab" href="#tab-event2"><i class="fa fa-list-alt" aria-hidden="true"></i> Details</a></li>
							<li  role="presentation" style="padding: 0px !important;"><a role="tab" data-toggle="tab" href="#tab-event3"><i class="fa fa-microphone" aria-hidden="true"></i> Speakers</a></li>
							<!--<li  role="presentation" style="padding: 0px !important;"><a  role="tab" data-toggle="tab" href="#tab-event4"><i class="fa fa-map-marker" aria-hidden="true"></i> Location</a></li>-->
							<li  role="presentation" style="padding: 0px !important;"><a  role="tab" data-toggle="tab" href="#tab-event5"><i class="fa fa-paper-plane" aria-hidden="true"></i> Contact</a></li>
						</ul>
				...
				<div class="col-md-3" style="padding-left: inherit !important;">
					<!-- event detail event3 -->
					...
					<section id="register" style="display:-webkit-inline-box !important;">
